...
#ifndef FLOWGRAMMABLE_OFP_AGENT_v1_3_1_HPP
#define FLOWGRAMMABLE_OFP_AGENT_v1_3_1_HPP
...
/// \brief The v1.3.1 OpenFlow interface for a switch
///
...
struct Agent : flog::ofp::Application
{
  ...
  /// Interface for receiving Multipart Request message
  virtual void multipart_request(const Multipart_req& mr, const Time& t)    {}
  ...
  /// Interface for receiving Get Async Request message
  virtual void get_async_request(const Get_async_req& gar, const Time& t)   {}
  /// Interface for receiving Set Async message
  virtual void set_async(const Set_async& sa, const Time& t)                {}
  /// Interface for receiving Meter Mod message
  virtual void meter_mod(const Meter_mod& mm, const Time& t)                {}
};
