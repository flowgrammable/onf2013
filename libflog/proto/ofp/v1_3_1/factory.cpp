...
/// \brief Make a version 1.3.1 hello message
///
/// The param version_bitmap is not used in this version
Message*
Factory::make_hello(uint32_t version_bitmap) { 
  return make<Hello>(gen(),
                     Sequence<Hello_element>{{Hello_element_version_bitmap({Version_bitmap{version_bitmap}})}});
}

/// \brief Make a version 1.3.1 hello error message
Message*
...
/// \brief Make a version 1.3.1 request error message due to slave role
Message* 
...
/// \brief Make a version 1.3.1 features request message
Message*
Factory::make_feature_req() { return make<Feature_req>(gen()); }

/// \brief Make a version 1.3.1 features response message
Message* 
...
/// \brief Make a version 1.3.1 flow mod message
Message*
...
/// \brief Make a version 1.3.1 packet out message
Message*
...
/// \brief Make a version 1.3.1 echo request message
Message*
Factory::make_echo_req() {
  return make<Echo_req>(gen());
}

/// \brief Make a version 1.3.1 echo response message
Message*
