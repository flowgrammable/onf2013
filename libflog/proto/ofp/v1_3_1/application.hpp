...
#ifndef FLOWGRAMMABLE_OFP_APPLICATION_v1_3_1_HPP
#define FLOWGRAMMABLE_OFP_APPLICATION_v1_3_1_HPP
...
///
/// An OpenFlow v1.3.1 control application is implemented by inheriting
...
struct Application : flog::ofp::Application
{
  ...
  /// Interface for receiving Multipart Reply message
  virtual void multipart_response(const Multipart_res& mr, const Time& t) { }
  ...
  /// Interface for receiving Role Reply message
  virtual void role_response(const Role_res& rr, const Time& t) { }
  /// Interface for receiving Get Async Reply message
  virtual void get_async_response(const Get_async_res& gar, const Time& t) { }
};
