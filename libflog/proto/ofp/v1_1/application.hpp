...
#ifndef FLOWGRAMMABLE_OFP_APPLICATION_v1_1_HPP
#define FLOWGRAMMABLE_OFP_APPLICATION_v1_1_HPP
...
///
/// An OpenFlow v1.1 control application is implemented by inheriting
