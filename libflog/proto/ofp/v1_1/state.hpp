...
#ifndef FLOWGRAMMABLE_FSM_V1_1_H
#define FLOWGRAMMABLE_FSM_V1_1_H
...
struct FSM_switch 
{
  ...
  FSM_switch(const FSM_config& c, Xid_generator<uint32_t>& g, Agent& a) 
    : state(IDLE), config(c), gen(g), agent(a) { }
