...
/// \brief Make a version 1.1 features request message
Message*
Factory::make_feature_req() { return make<Feature_req>(gen()); }

/// \brief Make a version 1.1 features response message
Message* 
...
/// \brief Make a version 1.1 flow mod message
Message*
...
/// \brief Make a version 1.1 packet out message
Message*
...
/// \brief Make a version 1.1 echo request message
Message*
Factory::make_echo_req() {
  return make<Echo_req>(gen());
}

/// \brief Make a version 1.1 echo response message
Message*
