...
/// \brief Make a version 1.2 request error message due to slave role
Message* 
...
/// \brief Make a version 1.2 features request message
Message*
Factory::make_feature_req() { return make<Feature_req>(gen()); }

/// \brief Make a version 1.2 features response message
Message* 
...
/// \brief Make a version 1.2 flow mod message
Message*
...
/// \brief Make a version 1.2 packet out message
Message*
...
/// \brief Make a version 1.2 echo request message
Message*
Factory::make_echo_req() {
  return make<Echo_req>(gen());
}

/// \brief Make a version 1.2 echo response message
Message*
