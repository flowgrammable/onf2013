...
#ifndef FLOWGRAMMABLE_OFP_APPLICATION_v1_2_HPP
#define FLOWGRAMMABLE_OFP_APPLICATION_v1_2_HPP
...
///
/// An OpenFlow v1.2 control application is implemented by inheriting
