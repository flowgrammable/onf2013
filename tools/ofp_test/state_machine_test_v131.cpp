...
#include <libflog/proto/ofp/v1_3_1/factory.hpp>
#include <libflog/proto/ofp/v1_3_1/state.hpp>

using namespace flog;
using namespace flog::ofp;
using namespace flog::ofp::v1_3_1;

struct Test_agent : v1_3_1::Agent {
...
int switch_test() {
  ...
  FSM_config c(FSM_config::v1_3_1, FSM_config::a1_3, tc);
  ...
  v1_3_1::Factory f = v1_3_1::Message::factory(xid);
...
struct Test_app : public v1_3_1::Application {
  void init(const Time& t) {}
};
