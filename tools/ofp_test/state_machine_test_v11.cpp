...
#include <libflog/proto/ofp/v1_1/factory.hpp>
...
int switch_test() {
  ...
  FSM_config c(FSM_config::v1_1, FSM_config::a1_1, tc);
  ...
  v1_1::Factory f = v1_1::Message::factory(xid);
...
struct Test_app : public v1_1::Application {
  void init(const Time& t) { }
};
